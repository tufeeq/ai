...
import {createHaltWatcher} from './src/halts.mjs';
...
const handle=createHandler({runtime,sharia:createSharia(),halts:createHaltWatcher(),consolidated:createConsolidated(),closes:createSipCloses()});
