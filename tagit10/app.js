(() => {
  ...
  const titles = {early:'الفرص المبكرة',actionable:'اجتازت الفلترة',confirmed:'رصد متكرر — غير معتمد للتداول',watch:'حركة نامية — قائمة المتابعة',invalidated:'اتجاه ضعيف أو حركة ممتدة',unavailable:'بيانات غير مكتملة أو متأخرة'};
  ...
  function rows(){
    const map=new Map();
    for(const key of ['watch','early','actionable','confirmed','invalidated','unavailable']) for(const x of data?.[key]||[]){
